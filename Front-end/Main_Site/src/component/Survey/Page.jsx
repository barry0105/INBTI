    ...
    const Question = [
        {
            ...
            'Answer' : ['같이 공부하면 집중도 안 될 것 같아. 혼자 공부한다.',
                        '함께 공부하면 서로 모르는 것도 알려주고 더 공부가 잘될 거야! 친구와 함께 공부한다.'], /* 질문에 대한 응답 입력 왼쪽부터 위 */
            'Values' : ['I','E'] /* 각 대답 별 성향 입력 왼쪽부터 1번 (I, E | S, N | T, F | J, P) */
        },
        { /* 모두 동일 새로 형식만 맞춰서 추가 바람 */
            'id' : 1,  
            'Question' : '당일에 친구가 약속을 파투 냈다. 나는?',
        ...
        },
        {
            ...
            'Answer' : ['친구 만들기는 타이밍! 내가 먼저 다가간다.',
                        '앉아 있으면 누구라도 말을 걸어주지 않을까... 가만히 앉아서 기다린다.'],
            'Values' : ['E','I']
        },
        {
            'id' : 3,
        ...
        },
        {
            ...
            'image' : '../../../img/survey_img/01.png',
            'Answer' : ['전화 주문은 좀 그런데... 앱 주문이 가능한 다른 메뉴를 시킨다.',
                        '먹고 싶은 메뉴는 먹어야지! 그냥 전화 주문 한다.'],
            'Values' : ['I','E']
        },{
            'id' : 9,
            ...
            'id' : 14,
            'Question' : '소중한 사람에게 "우리 생각할 시간을 가지자." 라는 말을 들었다. 내가 생각하기에 지금 우리는...',
            'image' : '../../../img/survey_img/01.png',
            'Answer' : ['안 맞는거 같다..',
                        '진짜 생각할 시간이 필요해'],
            'Values' : ['F','T']
            ...
            'Question' : '공부 하기 싫다...',
            'image' : '../../../img/survey_img/01.png',
            'Answer' : ['내가 이걸 왜 해야하지? 공부를 안 하는 세상이었다면 어떻게 굴러갔을까...',
                        '그냥 하기 싫다...'],
            'Values' : ['N','S']
        },{
            'id' : 27,
            ...
            'Answer' : ['여기 여기는 꼭 가자. 음식은 뭐 주변 식당에서 대충 먹고.',
                        '첫날에는 어디를 가서 몇시에 뭐를 하고 몇시에는 뭐를 하고...'],
            'Values' : ['P','J']
        },{
            'id' : 28,
            'Question' : '방 청소를 할 떄 나는?',
            'image' : '../../../img/survey_img/01.png',
            'Answer' : ['대충대충 눈에 보이는 곳만 정리하고... 물건은 중구난방인데 괜찮아!',
                        '완벽하게 정리한다! 물건은 정해진 자리에 둬야지.'],
            'Values' : ['P','J']
        },{
            'id' : 29,
            'Question' : '약속이 잡힌 날 나는?',
            'image' : '../../../img/survey_img/01.png',
            ...
            'image' : '../../../img/survey_img/01.png',
            'Answer' : ['편-안하다. 내가 짜놓은 루틴 대로 돌아가고 있구나...',
                        '인생이 아니라 쳇바퀴같아... 어딘가 변화를 주고 싶어'],
            'Values' : ['J','P']
        },{
            'id' : 31,
            ...
            'Answer' : ['그 식당 저번에 차 많았는데, 주차할 장소 알아봐야겠다.',
                        '가자! 자리 있으면 대고 아니면 좀 헤매지 뭐!'],
            'Values' : ['J','P']
        },{
            'id' : 33,
            'Question' : '친구들을 집에 초대했다. 음식 양이 애매한데...',
            'image' : '../../../img/survey_img/01.png',
            ...
            'Question' : '다음 주 시험이다.',
            'image' : '../../../img/survey_img/01.png',
            'Answer' : ['다음 주면 아직 시간 많네! 3일 전부터 해도 충분해~',
                        '오늘 이 분량까지는 공부해야겠네...'],
            'Values' : ['P','J']
        },{
            'id' : 35,
